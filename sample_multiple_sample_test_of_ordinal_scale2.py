        ...
        if args[1] == "1":
           ...
           (心理学のためのデータ解析テクニカルブック p. 213 を参照)
            ...
            Condition    A     B     C
                        ...
                        5.20  5.48  2.18
            '''
            data_a = [3.88,4.60,6.30,2.15,4.80,5.20]
            data_b = [2.86,9.02,4.27,9.86,3.66,5.48]
            data_c = [1.82,4.21,3.10,1.99,2.75,2.18]
            ...
            H, p = kruskal(data_a, data_b, data_c)
            ...
            '''
            data_a = [1,5,1,5,5,4,5]
            data_b = [2,1,2,1,4,2,4]
            data_c = [3,3,3,4,2,1,2]
            data_d = [5,2,4,2,3,3,3]
            data_e = [4,4,5,3,1,5,1]
            ...
            statistic, p = friedmanchisquare(data_a, data_b, data_c, data_d, data_e)
